...
extension UIAlertController {
    ...
    class func showActionsheetForImagePicker(_ controller : AnyObject ,
        ...
        self.showAlert(controller, strTitle: strTitle, aStrMessage: aStrMessage, style: .actionSheet, aCancelBtn: "Cancel", aDistrutiveBtn: nil, otherButtonArr: ["Use Gallery", "Use Camera"], completion: completion)
    ...
    class func showActionsheetForLogout(_ controller : AnyObject ,
        ...
        self.showAlert(controller, position : position ,strTitle: strTitle, aStrMessage: aStrMessage, style: .actionSheet, aCancelBtn: "Cancel", aDistrutiveBtn: "Logout", otherButtonArr: nil, completion: completion)
